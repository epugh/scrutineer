...
public class IdAndVersionTest {
    ...
    @Test public void shouldBeEqualWhenIdAndVersionAreTheSame() {
    ...
    @Test public void shouldNotBeEqualWhenIdsDiffer() {
        IdAndVersion idAndVersion1 = new IdAndVersion("2",3);
    ...
    @Test public void shouldNotBeEqualWhenVersionsDiffer() {
    ...
    @Test public void shouldGet0WhenComapringEqualObjects() {
        IdAndVersion idAndVersion1 = new IdAndVersion("2",3);
        IdAndVersion idAndVersion2 = new IdAndVersion("2",3);
        assertThat(idAndVersion1.compareTo(idAndVersion2), is(0));
    }

    @Test public void shouldGetn1WhenComapringLesserIds() {
        IdAndVersion idAndVersion1 = new IdAndVersion("2",3);
        IdAndVersion idAndVersion2 = new IdAndVersion("3",3);
        assertThat(idAndVersion1.compareTo(idAndVersion2), is(-1));
    }

    @Test public void shouldGetn1WhenComapringLesserVersions() {
        IdAndVersion idAndVersion1 = new IdAndVersion("2",3);
        IdAndVersion idAndVersion2 = new IdAndVersion("2",4);
        assertThat(idAndVersion1.compareTo(idAndVersion2), is(-1));
    }

    @Test public void shouldGet1WhenComapringGreaterIds() {
        IdAndVersion idAndVersion1 = new IdAndVersion("2",3);
        IdAndVersion idAndVersion2 = new IdAndVersion("1",3);
        assertThat(idAndVersion1.compareTo(idAndVersion2), is(1));
    }

    @Test public void shouldGet1WhenComapringGreaterVersions() {
        IdAndVersion idAndVersion1 = new IdAndVersion("2",3);
