...
public class CliOptionV2ToConfigConverterTest {
    ...
    public void setUp() {
        ...
        commandLineOptionsV2.secondaryConfig = "com/aconex/scrutineer/v2/elastic-search.properties";
    ...
    public void getConnectorConfigsShouldLoadPropertiesFromClassPath() {
        ...
        assertThat(((ElasticSearchStreamConnector.Config)config.getSecondaryConnectorConfig()).getIndexName(), is("test"));
    }
